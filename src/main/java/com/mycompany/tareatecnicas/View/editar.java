...
public class Editar extends javax.swing.JFrame {
    ...
    public Editar(String nombre, String telefono, String fecha, int intencion) {
        initComponents();
        editornombre.setText(nombre);
        editortelefono.setText(telefono);
        String[] fecha_ = fecha.split("-");
        dia.setText(fecha_[2]);
        mes.setText(fecha_[1]);
        año.setText(fecha_[0]);
        if (intencion >= 0) {
        ...
        this.res_data[2] = fecha;
        this.res_intencion = intencion;
    }
    ...
    private void initComponents() {
        ...
        agregarcontactobutton.setText("Confirmar");
        ...
        jLabel4.setText("Editar contacto");
    ...
    private void agregarcontactobuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregarcontactobuttonActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(null, "Se editó al usuario " + nombre + ".");
    ...
    private void cerrarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cerrarButtonActionPerformed
        if (mujercheck.isSelected()) {
            ContactoMujer contacto = new ContactoMujer(res_data[0], res_data[1], res_data[2], res_intencion);
            AgregarContacto.agregarContacto(contacto);    
            new PersonaDAO().agregar(contacto);
        } else {
            ContactoHombre contacto = new ContactoHombre(res_data[0], res_data[1], res_data[2]);
            AgregarContacto.agregarContacto(contacto);    
            new PersonaDAO().agregar(contacto);
        }
        Menu menuFrame = new Menu();
